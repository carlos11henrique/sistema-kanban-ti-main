...
app.use('/blocos', verify, authorize([ROLES.NOA, ROLES.TI, ROLES.MANUTENCAO, ROLES.DOCENTE, ROLES.ESTUDANDE, ROLES.FUNCIONARIOS, ROLES.ESTAGIARIO]), blocosRoutes);
app.use('/salas', verify, authorize([ROLES.NOA, ROLES.TI, ROLES.MANUTENCAO, ROLES.DOCENTE, ROLES.ESTUDANDE ,ROLES.FUNCIONARIOS, ROLES.ESTAGIARIO]), salasRoutes);
app.use('/maquinas', verify, authorize([ROLES.NOA, ROLES.TI, ROLES.MANUTENCAO, ROLES.DOCENTE, ROLES.ESTUDANDE, ROLES.FUNCIONARIOS, ROLES.ESTAGIARIO]), maquinasRoutes);
app.use('/problemas', verify, problemasRoutes);
app.use('/chamados', verify, authorize([ROLES.NOA, ROLES.TI, ROLES.MANUTENCAO, ROLES.DOCENTE, ROLES.ESTUDANDE,,ROLES.FUNCIONARIOS, ROLES.ESTAGIARIO]), chamadosRoutes);
app.use('/chamados-maquinas', verify, authorize([ROLES.NOA, ROLES.TI, ROLES.MANUTENCAO, ROLES.DOCENTE, ROLES.ESTUDANDE,ROLES.FUNCIONARIOS, ROLES.ESTAGIARIO]), chamadosMaquinasRoutes);
