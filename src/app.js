...
app.use('/blocos', verify, authorize([ROLES.NOA, ROLES.TI, ROLES.MANUTENCAO, ROLES.DOCENTE, ROLES.ESTUDANDE, ROLES.FUNCIONARIOS, ROLES.ESTAGIARIO,ROLES.TERCEIRO]), blocosRoutes);
app.use('/salas', verify, authorize([ROLES.NOA, ROLES.TI, ROLES.MANUTENCAO, ROLES.DOCENTE, ROLES.ESTUDANDE ,ROLES.FUNCIONARIOS, ROLES.ESTAGIARIO, ROLES.TERCEIRO]), salasRoutes);
app.use('/maquinas', verify, authorize([ROLES.NOA, ROLES.TI, ROLES.MANUTENCAO, ROLES.DOCENTE, ROLES.ESTUDANDE, ROLES.FUNCIONARIOS, ROLES.ESTAGIARIO, ROLES.TERCEIRO]), maquinasRoutes);
app.use('/problemas', verify, problemasRoutes);
app.use('/chamados', verify, authorize([ROLES.NOA, ROLES.TI, ROLES.MANUTENCAO, ROLES.DOCENTE, ROLES.ESTUDANDE,,ROLES.FUNCIONARIOS, ROLES.ESTAGIARIO, ROLES.TERCEIRO]), chamadosRoutes);
app.use('/chamados-maquinas', verify, authorize([ROLES.NOA, ROLES.TI, ROLES.MANUTENCAO, ROLES.DOCENTE, ROLES.ESTUDANDE,ROLES.FUNCIONARIOS, ROLES.ESTAGIARIO, ROLES.TERCEIRO]), chamadosMaquinasRoutes);
